...
const TrainerList = () => {
  ...
  return (
    <div className="flex justify-center">
      <div className="flex flex-col items-center min-h-[60dvh] space-y-14 my-10 bg-white p-14 rounded-lg shadow-lg">
        <div className="flex flex-row items-center w-full">
          <p className="font-semibold text-xl flex items-center text-start">
        ...
        <div className="">
          ...
          {Array.isArray(trainers) && trainers.length > 0 ? (
            ...
            <div className="h-[300px] flex items-center justify-center">
              <div>
                등록된 트레이너가 없습니다.. <span className="text-xl">🙅</span>
              </div>
            </div>
          )}
