...
// const ReviewContent = ({ gymId, renderReviewCount = false, reviewCount, onReviewAdded }) => {
...
//           onReviewAdded(data.length); // Update review count
//         }
//       } catch (error) {
...
//     };
//     fetchReviews();
//   }, [gymId, renderReviewCount, onReviewAdded]);
...
//           if (!renderReviewCount && typeof onReviewAdded === 'function') {
//             onReviewAdded(reviews.length - 1); // Update review count
//           }
//         })
//         .catch((error) => {
