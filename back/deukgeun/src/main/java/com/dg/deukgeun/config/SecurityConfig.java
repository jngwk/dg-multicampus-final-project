    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        "/api/gym/search/**", "/api/gym/get/**", "/api/gym/getList", "/api/gym/getListWithPaging","/api/reviews/reviewList/**").permitAll() // 이 API는 인증 없이 접근 가능하도록 설정합니다.
                        ...
                        .requestMatchers("/api/membership/stats", "/api/membership/stats/**","/api/user/signUp/trainer", "/api/trainers/update/**","/api/gym/put/**").hasAnyAuthority("ROLE_GYM")
